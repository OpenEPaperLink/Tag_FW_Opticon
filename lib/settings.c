...
static bool compareSettings(void) {
    __xdata uint8_t* __xdata settingsTempBuffer = malloc(128);
...
static void upgradeSettings(void) {
...
void invalidateSettingsEEPROM(void) {
